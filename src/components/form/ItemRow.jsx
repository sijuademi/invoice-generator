// components/form/ItemRow.jsx
// Problem: a single item row mixes input rendering, live total calculation,
//          and delete interaction — too many concerns for one place.
// Solution: own exactly one row: its inputs, its derived total, and its removal.
  ...
  return (
    <button
      ...
      style={{
        ...
        alignSelf: "flex-end", paddingBottom: 14,
      }}
    >
    ...
    >
      ...
      <div
        style={{
          ...
          color: t.label, fontSize: 12, fontWeight: 700,
        }}
      >
        {lineTotal.toFixed(2)}
      </div>
